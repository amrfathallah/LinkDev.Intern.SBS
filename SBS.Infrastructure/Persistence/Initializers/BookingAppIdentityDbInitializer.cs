...
{
	public sealed class BookingAppIdentityDbInitializer(AppDbContext _context, UserManager<ApplicationUser> _userManager, RoleManager<IdentityRole<Guid>> _roleManager) : DbInitializer(_context), IDbInitializer
	{
